...
const ToggleLightDark = () => {
  ...
  return (
    <div className='mx-4 flex h-12 flex-col items-center justify-center space-y-5 rounded-[6px] bg-grey_light transition-colors duration-150 dark:bg-grey_verydark'>
